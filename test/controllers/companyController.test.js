...
describe('Company Controller', () => {
  describe('Fetch company score and store', () => {
    it('Should give success message on storing', async () => {
      const mockReq = {
        body: {
          urlLink: 'something',
        }
      ...
      jest.spyOn(companyServices, 'getCompaniesInEachSector').mockResolvedValue('something');
